...
### 🏆 Certification
![C Programming Certificate](assests/c_certificate.png)
...
- [ ] **02. Simple Calculator:** A utility tool demonstrating `switch` cases and basic arithmetic operations.
- [ ] **03. Digital Clock:** A real-time clock built using the `<time.h>` library and screen-clearing functions.
- [ ] **04. Progress Bar:** A visual command-line loading bar to practice formatted output and timing delays.
- [ ] **05. User Management:** A system handling user registration and login, introducing basic file handling (`fopen`, `fwrite`).
- [ ] **06. Banking System:** An expanded system simulating account creation, deposits, and withdrawals using persistent file storage.
- [ ] **07. Sudoku Solver:** A logic-based project utilizing 2D arrays and the backtracking algorithm.
- [ ] **08. Tic-Tac-Toe:** A 2-player grid game focusing on complex win-condition logic and array manipulation.
- [ ] **09. Snake Game:** A real-time terminal game demonstrating non-blocking input and coordinate rendering.
